...
df['length_alphabets'] = df['text'].apply(get_length_alphabets)
df['length_words'] = df['text'].apply(get_length_words)
...
df.drop(['length_alphabets', 'length_words', 'title_size'], axis=1, inplace=True)
